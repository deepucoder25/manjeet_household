...
<section class="service-breadcrumbs text-center">
    <div class="container">
        <h1 class="bc-title-main text-uppercase text-white fw-bold">Household Shifting</h1>
        ...
        <div class="bc-capsule-container d-inline-flex align-items-center justify-content-between p-1 bg-white border border-danger shadow-sm">
            ...
            <span class="bc-current-pill text-white bg-danger font-weight-bold">Household Shifting</span>
        </div>
    </div>
</section>
