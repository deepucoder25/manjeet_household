...
<?php $this->load->view('template/breadcrumb', array('breadcrumb_title' => 'Privacy Policy', 'breadcrumb_icon' => 'bi-shield-lock')); ?>
            ...
            <div class="col-lg-8">
                <div class="about-legal-card shadow-sm">
                    ...
                    <div class="about-legal-section mt-4">
                        <h3 class="about-legal-title">1. Information We Collect</h3>
                        <div class="about-legal-desc">
                            <p>When you request a quote, contact us, or hire our shifting services, we may collect the following personal information:</p>
                    ...
                    <div class="about-legal-section">
                        <h3 class="about-legal-title">2. How We Use Your Information</h3>
                        <div class="about-legal-desc">
                    ...
                    <div class="about-legal-section">
                        <h3 class="about-legal-title">3. Data Security &amp; Protection</h3>
                        <div class="about-legal-desc">
                            <p>
                    ...
                    <div class="about-legal-section">
                        <h3 class="about-legal-title">4. Cookies</h3>
                        <div class="about-legal-desc">
                            <p>
                    ...
                    <div class="about-legal-section">
                        <h3 class="about-legal-title">5. Third-Party Sharing</h3>
                        <div class="about-legal-desc">
                            <p>
                    ...
                    <div class="about-legal-section mb-0">
                        <h3 class="about-legal-title">6. Contact Information</h3>
                        <div class="about-legal-desc">
                            <p>
