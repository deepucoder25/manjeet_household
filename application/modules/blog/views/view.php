...
<main class="main">
    ...
    <?php $this->load->view('template/breadcrumb', array('breadcrumb_title' => 'Blog Details', 'breadcrumb_icon' => 'bi-journal-text', 'breadcrumb_current' => htmlspecialchars(@$query[0]->title), 'breadcrumb_parent_name' => 'Our Blog', 'breadcrumb_parent_url' => site_url('blog'))); ?>
