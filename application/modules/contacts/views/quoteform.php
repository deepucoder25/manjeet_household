        ...
        <div class="row g-2">
          ...
          <div class="col-12 form-group-custom">
            <div class="input-wrap-custom">
              ...
              <input type="text" name="mdate" class="form-control-custom" placeholder="Moving Date" onfocus="(this.type='date')" onblur="if(!this.value)this.type='text'">
            </div>
          </div>
          ...
          <div class="col-12 form-group-custom">
            <div class="input-wrap-custom">
              ...
              <input type="text" name="comments" class="form-control-custom" placeholder="Additional Details (Optional)">
            </div>
          </div>
